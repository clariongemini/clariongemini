...
// Sadece işlenmemiş ('islendi' = 0) bildirim olaylarını al
$stmt = $pdo->prepare("SELECT olay_id, olay_tipi, veri FROM olay_gunlugu WHERE olay_tipi IN ('siparis.basarili', 'siparis.kargolandi') AND islendi = 0 ORDER BY olay_id ASC");
$stmt->execute();
