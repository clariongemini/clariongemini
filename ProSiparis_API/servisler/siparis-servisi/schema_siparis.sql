...
CREATE TABLE `siparisler` ( `id` INT AUTO_INCREMENT PRIMARY KEY, `kullanici_id` INT NOT NULL, `atanan_depo_id` INT NULL, `toplam_tutar` DECIMAL(10, 2) NOT NULL, `durum` ENUM('Odeme Bekleniyor', 'Odendi', 'Hazirlaniyor', 'Kargoya Verildi', 'Teslim Edildi', 'Iptal Edildi') NOT NULL ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
-- v7.5 Denetim Kaydı (Audit Log) Tablosu
CREATE TABLE `siparis_gecmisi_loglari` (
